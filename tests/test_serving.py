...
# NOTE (018 T358): the llama-specific `test_llama_reaps_stuck_child_before_relaunch` retired with
# `serving/llama/supervisor.py`. Reap-before-relaunch (FR-167) is now structural in the SHARED
# engine lifecycle, pinned for EVERY engine by
# tests/test_agent_lifecycle.py::test_stuck_child_is_reaped_before_relaunch_for_every_engine.
