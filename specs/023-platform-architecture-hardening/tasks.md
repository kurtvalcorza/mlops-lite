...
- [ ] **T523** [US5] Extend the 022 host-agent reload command in `hostagent/main.py`, lifecycle/swap,
  and shared contracts with `operation_id` idempotency, same-target no-op, conflicting-target reject,
  pre-eviction probe, and exact resident verification (FR-307/308/312).
