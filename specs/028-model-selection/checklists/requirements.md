...
The deviation is bounded: every **requirement** (FR-439–FR-477f) is stated as an observable
...
FR-476–FR-477f were added. A hand-maintained range in prose re-stales every time the spec grows, and
